...
router.post('/product', upload.none(), createProductOffer); // Create a product offer
router.get('/product', getAllProductOffers); // Get all product offers
router.post('/product/edit/:id', upload.none(), updateProductOffer); // Update a product offer (changed from PUT to POST)
