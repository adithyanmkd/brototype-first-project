...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function userRegister() {
    ...
    userRegisterForm.addEventListener('submit', async (e) => {
      ...
      const fullname = userRegisterForm
        .querySelector("[name='fullname']")
        .value.trim();
      const email = userRegisterForm
        .querySelector("[name='email']")
        .value.trim();
      const password = userRegisterForm
        .querySelector("[name='password']")
        .value.trim();
      const confirmPass = userRegisterForm
  ...
  function forgetPassword() {
    ...
    forgetPassForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        console.error({
          Error: error,
          DeveloperNote: 'Error in forget password',
        });
      } finally {
        submitButton.disabled = false;
